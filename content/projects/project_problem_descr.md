...
4. General whole app UI improvements and additions
    - UI additions, e.g., Carousel on the main screen to view events, screen transitions
    - UI responsivenss, e.g., different sized devices using the app should have different font sizes and padding
    - UI polish, generally looks nicer than default
6. Entrant profiles that keeps track of preferences
