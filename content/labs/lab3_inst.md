...
1. Going through Lab 3 Slides PDF ([customize ArrayAdapter and Fragments](slides/Lab_3_Slides_Winter_2023.pdf))
2. Supporting a ListView with items that have multiple views using a custom ArrayAdapter and Using a Fragment to add new cities to ListyCity ([customize ArrayAdapter and Fragments code & walkthrough](slides/Lab_3_Instructions_Winter_2023.pdf))
